...
<html lang="fr">
  ...
  <body>
    <center-block>
      <h2>${projectName}</h2>
      <p>Bienvenue dans le système de documentation</p>
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">Commencer</a>
        </p-button>
      </div>
    </center-block>
  </body>
  ...
  "{lang}/documentation/introduction.md": () => `# Bienvenue
...
<g id="Layer_1">
  ...
  <p>Copyright © ${new Date().getFullYear()} ${projectName}. Tous droits réservés.</p>
</template>`,
};
