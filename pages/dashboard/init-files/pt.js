...
<html lang="pt">
  ...
  <body>
    <center-block>
      <h2>${projectName}</h2>
      <p>Bem-vindo ao sistema de documentação</p>
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">Começar</a>
        </p-button>
      </div>
    </center-block>
  </body>
</html>`,
  "{lang}/documentation/_config.yaml": `- name: Introdução
  url: ./introduction.md`,

  "{lang}/documentation/introduction.md": () => `# Bem-vindo

Este é o seu primeiro documento.

## Começar

Você pode começar a escrever sua documentação aqui.

- Suporta sintaxe Markdown padrão
- Pode criar estruturas de diretórios multiníveis
- Suporta destaque de código
`,
...
<g id="Layer_1">
  ...
  <p>Copyright © ${new Date().getFullYear()} ${projectName}. Todos os direitos reservados.</p>
</template>`,
};
