...
<html lang="pl">
  ...
  <body>
    <center-block>
      <h2>${projectName}</h2>
      <p>Witamy w systemie dokumentacji</p>
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">Rozpocznij</a>
        </p-button>
      </div>
    </center-block>
  </body>
</html>`,
  "{lang}/documentation/_config.yaml": `- name: Wprowadzenie
  url: ./introduction.md`,

  "{lang}/documentation/introduction.md": () => `# Witamy

To jest Twój pierwszy dokument.

## Rozpocznij

Możesz zacząć pisać swoją dokumentację tutaj.

- Obsługuje standardową składnię Markdown
- Może tworzyć wielopoziomowe struktury katalogów
- Obsługuje podświetlanie kodu
`,
...
<g id="Layer_1">
  ...
  "{lang}/footer.html": (projectName) => `<template page>
  <style>
    :host {
      display: flex;
      ...
      align-items: center;
      height: 60px;
      max-width: var(--max-container-width, 1200px);
      margin: 0 auto;
      text-align: center;
    }
  </style>
  <p>Copyright © ${new Date().getFullYear()} ${projectName}. Wszelkie prawa zastrzeżone.</p>
</template>`,
};
