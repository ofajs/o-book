...
<html lang="de">
  ...
  <body>
    <center-block>
      <h2>${projectName}</h2>
      <p>Willkommen im Dokumentationssystem</p>
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">Loslegen</a>
        </p-button>
      </div>
    </center-block>
  </body>
</html>`,
  "{lang}/documentation/_config.yaml": `- name: Einführung
  url: ./introduction.md`,

  "{lang}/documentation/introduction.md": () => `# Willkommen
...
<g id="Layer_1">
  ...
  <p>Copyright © ${new Date().getFullYear()} ${projectName}. Alle Rechte vorbehalten.</p>
</template>`,
};
