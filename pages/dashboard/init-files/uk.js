...
<html lang="uk">
  ...
  <body>
    <center-block>
      <h2>${projectName}</h2>
      <p>Ласкаво просимо до системи документації</p>
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">Почати</a>
        </p-button>
      </div>
    </center-block>
  </body>
</html>`,
  "{lang}/documentation/_config.yaml": `- name: Вступ
  url: ./introduction.md`,

  "{lang}/documentation/introduction.md": () => `# Ласкаво просимо

Це ваш перший документ.

## Почати

Ви можете почати писати свою документацію тут.

- Підтримує стандартний синтаксис Markdown
- Можна створювати багаторівневі структури каталогів
- Підтримує підсвічування коду
`,
...
<g id="Layer_1">
  ...
  <p>Copyright © ${new Date().getFullYear()} ${projectName}. Всі права захищені.</p>
</template>`,
};
