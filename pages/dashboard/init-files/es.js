...
<html lang="es">
  ...
  <body>
    <center-block>
      <h2>${projectName}</h2>
      <p>Bienvenido al sistema de documentación</p>
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">Comenzar</a>
        </p-button>
      </div>
    </center-block>
  </body>
</html>`,
  "{lang}/documentation/_config.yaml": `- name: Introducción
  url: ./introduction.md`,

  "{lang}/documentation/introduction.md": () => `# Bienvenido
...
<g id="Layer_1">
  ...
  <p>Copyright © ${new Date().getFullYear()} ${projectName}. Todos los derechos reservados.</p>
</template>`,
};
