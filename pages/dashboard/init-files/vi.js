...
<html lang="vi">
  ...
  <body>
    <center-block>
      <h2>${projectName}</h2>
      <p>Chào mừng đến với hệ thống tài liệu</p>
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">Bắt đầu</a>
        </p-button>
      </div>
    </center-block>
  </body>
</html>`,
  "{lang}/documentation/_config.yaml": `- name: Giới thiệu
  url: ./introduction.md`,

  "{lang}/documentation/introduction.md": () => `# Chào mừng

Đây là tài liệu đầu tiên của bạn.

## Bắt đầu

Bạn có thể bắt đầu viết tài liệu của mình ở đây.

- Hỗ trợ cú pháp Markdown tiêu chuẩn
- Có thể tạo cấu trúc thư mục đa cấp
- Hỗ trợ tô sáng mã
`,
