...
<html lang="ko">
  ...
  <body>
    <center-block>
      <h2>${projectName}</h2>
      <p>문서 시스템에 오신 것을 환영합니다</p>
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">시작하기</a>
        </p-button>
      </div>
    </center-block>
  </body>
</html>`,
  "{lang}/documentation/_config.yaml": `- name: 소개
  url: ./introduction.md`,

  "{lang}/documentation/introduction.md": () => `# 환영합니다
