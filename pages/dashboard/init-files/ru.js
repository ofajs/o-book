...
<html lang="ru">
  ...
  <body>
    <center-block>
      <h2>${projectName}</h2>
      <p>Добро пожаловать в систему документации</p>
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">Начать</a>
        </p-button>
      </div>
    </center-block>
  </body>
</html>`,
  "{lang}/documentation/_config.yaml": `- name: Введение
  url: ./introduction.md`,

  "{lang}/documentation/introduction.md": () => `# Добро пожаловать

Это ваш первый документ.

## Начать

Вы можете начать писать свою документацию здесь.

- Поддерживает стандартный синтаксис Markdown
- Можно создавать многоуровневые структуры каталогов
...
<g id="Layer_1">
  ...
  <p>Copyright © ${new Date().getFullYear()} ${projectName}. Все права защищены.</p>
</template>`,
};
