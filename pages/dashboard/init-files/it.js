...
<html lang="it">
  ...
  <body>
    <center-block>
      <h2>${projectName}</h2>
      <p>Benvenuto nel sistema di documentazione</p>
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">Inizia</a>
        </p-button>
      </div>
    </center-block>
  </body>
</html>`,
  "{lang}/documentation/_config.yaml": `- name: Introduzione
  url: ./introduction.md`,

  "{lang}/documentation/introduction.md": () => `# Benvenuto

Questo è il tuo primo documento.

## Inizia

Puoi iniziare a scrivere la tua documentazione qui.

- Supporta la sintassi Markdown standard
- Può creare strutture di directory multilivello
...
<g id="Layer_1">
  ...
  <p>Copyright © ${new Date().getFullYear()} ${projectName}. Tutti i diritti riservati.</p>
</template>`,
};
