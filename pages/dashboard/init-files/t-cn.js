  ...
  <body>
    <center-block>
      ...
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">開始使用</a>
        </p-button>
      </div>
    </center-block>
  </body>
</html>`,
  "{lang}/documentation/_config.yaml": `- name: 介紹
  url: ./introduction.md`,

  "{lang}/documentation/introduction.md": () => `# 歡迎
...
<g id="Layer_1">
  ...
  <p>版權所有 © ${new Date().getFullYear()} ${projectName}. 保留所有權利.</p>
</template>`,
};
