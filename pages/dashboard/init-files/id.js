...
<html lang="id">
  ...
  <body>
    <center-block>
      <h2>${projectName}</h2>
      <p>Selamat datang di sistem dokumentasi</p>
      <div style="padding: 16px">
        <p-button size="large">
          <a href="./documentation/introduction.md">Mulai</a>
        </p-button>
      </div>
    </center-block>
  </body>
</html>`,
  "{lang}/documentation/_config.yaml": `- name: Pengantar
  url: ./introduction.md`,

  "{lang}/documentation/introduction.md": () => `# Selamat Datang

Ini adalah dokumen pertama Anda.

## Memulai

Anda dapat mulai menulis dokumentasi Anda di sini.

- Mendukung sintaks Markdown standar
- Dapat membuat struktur direktori multi-level
- Mendukung penyorotan kode
`,
...
<g id="Layer_1">
  ...
  <p>Copyright © ${new Date().getFullYear()} ${projectName}. All rights reserved.</p>
</template>`,
};
